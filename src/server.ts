  ...
  const server = new McpServer(
    { name: PACKAGE_NAME, version: VERSION },
    {
      instructions:
        ...
        'профили целиком. Узлы сценария у платформ одни и те же, а варианты в их настройках ' +
        'разные — берите каталог с platform, иначе соберёте сценарий с вариантом, которого у ' +
        'платформы бота нет.\n\n' +
